...
Logger.info('www - server was initialized successfully, waiting for app to get ready... qwe');
console.log("PORT", WWW_PORT)
...
app.on('ready', () => {
  ...
  Logger.info('www - server was started successfully... at ', WWW_PORT);
});
